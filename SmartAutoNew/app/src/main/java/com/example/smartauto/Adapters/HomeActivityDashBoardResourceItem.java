...
public class HomeActivityDashBoardResourceItem {
    String itemValue1;
    int itemValue1TextSize;
    String itemValue2;
    Integer itemIcon;
    public HomeActivityDashBoardResourceItem(String _itemValue1, int _itemValue1TextSize, String _itemValue2, Integer _itemIcon){
